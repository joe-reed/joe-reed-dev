  ...
  return (
    <div className="flex flex-col min-h-screen pt-20 md:py-10 font-mono bg-seashell text-gray-900">
      ...
      <main className="flex flex-col items-center md:justify-center w-full flex-1 px-10 text-center tracking-tighter">
        ...
        <div className="flex flex-wrap items-center mt-6 w-full px-20">
          <div className="w-full lg:w-1/3 flex justify-center lg:px-2 mb-3 lg:mb-0">
            <Link
          ...
          <div className="w-full lg:w-1/3 flex justify-center lg:px-2">
            <Link
